...
"""tst_dhparser_project_grammar.py - runs the unit tests for the dhparser_project-grammar
"""
...
if __name__ == '__main__':
    ...
    if args.scripts:
        dsl.create_scripts(os.path.join(scriptdir, 'dhparser_project.ebnf'))
    ...
    if arg.endswith('.ebnf'):
        ...
        recompile_grammar(os.path.join(scriptdir, 'dhparser_project.ebnf'),
                          force=False)
        sys.path.append('.')
        from dhparser_projectParser import parsing, ASTTransformation, \
